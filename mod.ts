/**	MySQL and MariaDB driver for Deno. Tested on: MySQL 5.6, 5.7, 8.0, 9.0, MariaDB 5.5, 10.0, 10.2, 10.5, 10.7, 11.5.
	...
	However preparing SQL statement once (see [MySQL binary protocol]{@link #mysql-binary-protocol}, and then executing it many times is the fastest.
	...
	You can see [here]{@link https://github.com/jeremiah-shaulov/office_spirit_mysql/blob/v0.19.4/private/sql_log_to_writable.ts} how {@link SqlLogToWritable} class is implemented,
