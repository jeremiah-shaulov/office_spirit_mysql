...
```ts
import {SqlLogToWritable} from "https://deno.land/x/office_spirit_mysql@v0.19.6/mod.ts"
```
...
#### ⚙ `protected` nextConnBanner(dsn: [Dsn](../class.Dsn/README.md), connectionId: `number`): `string` | Uint8Array
