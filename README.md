...
- Transactions: regular, readonly, 2-phase, savepoints.
...
import {MyPool} from 'https://deno.land/x/office_spirit_mysql@v0.2.3/mod.ts';
...
import {MyPool, ColumnValue} from 'https://deno.land/x/office_spirit_mysql@v0.2.3/mod.ts';
...
import {MyPool, sql} from 'https://deno.land/x/office_spirit_mysql@v0.2.3/mod.ts';
