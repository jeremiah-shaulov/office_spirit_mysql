...
import {MyPool, ColumnValue} from 'https://deno.land/x/office_spirit_mysql@v0.6.0/mod.ts';
...
import {MyPool, sql} from 'https://deno.land/x/office_spirit_mysql@v0.6.0/mod.ts';
